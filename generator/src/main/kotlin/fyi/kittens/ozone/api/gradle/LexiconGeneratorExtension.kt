...
import fyi.kittens.ozone.api.generator.ApiReturnType.Raw
import fyi.kittens.ozone.api.generator.BinaryDataType
...
@Inject constructor(
  ...
  val namespace: Property<String> =
    objects.property<String>().convention("fyi.kittens.ozone")
