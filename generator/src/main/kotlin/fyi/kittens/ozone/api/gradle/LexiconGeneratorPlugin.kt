...
import fyi.kittens.ozone.buildconfig.Dependencies
...
private fun KotlinTarget.applyConfiguration(
  ...
  project.kotlinExtension.sourceSets.getByName(sourceSetName).apply {
    ...
    dependencies {
      ...
      api("fyi.kittens.ozone:api-gen-runtime:${Dependencies.OZONE}")

      // Keep some internal utility methods only on the runtime classpath
      implementation("fyi.kittens.ozone:api-gen-runtime-internal:${Dependencies.OZONE}")
    }
  }
